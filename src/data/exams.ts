...
export const examsData: ExamData[] = [
  {
    ...
    procedures: [
      "Abdome Inferior Feminino (Bexiga, Útero, Ovários e Anexos)",
      "Abdome Inferior Masculino (Bexiga, Próstata e Vesículas Seminais)",
      "Abdome Superior",
      "Abdome Total",
      "Abdome Total com Prova de Boyden",
      "Aparelho Urinário Feminino",
      "Aparelho Urinário Masculino",
      "Articulação (Ombro, Cotovelo, Punho, Quadril, Joelho, Tornozelo)",
      "Articulação Sacroilíaca",
      "Biópsia Percutânea Mamária (Core Biopsy)",
      "Bolsa Escrotal",
      "Bolsa Escrotal com Doppler",
      "Braço",
      "Calcâneo",
      "Doppler Colorido da Aorta e Artérias Renais",
      "Doppler Colorido da Aorta e Ilíacas",
      ...
      "Doppler Colorido de Vasos Cervicais (Artérias Carótidas)",
      "Doppler Colorido de Vasos Cervicais (Veias)",
      "Doppler Colorido de Veia Cava Inferior",
      "Doppler Colorido Transcraniano ou Transfontanela (Bebê até 8 meses ou se a moleira não estiver fechada)",
      "Ecocardiograma Fetal",
      "Elastografia",
      "Endovaginal / Transvaginal",
      "Endovaginal com Doppler",
      "Endovaginal para contagem de Folículos",
      "Estruturas Superficiais (Axilas, Região Cervical, Músculos, Tendões e Partes Moles)",
      "Glândulas Salivares",
      "Globo Ocular com Doppler",
      "Mamas",
      "Mamas com Axilas",
      "Mamas com Axilas e Doppler",
      "Mamas com Doppler",
      "Obstétrica 1º Trimestre (Endovaginal)",
      "Obstétrica 1º Trimestre Gemelar (Endovaginal) – CADA FETO",
      "Obstétrica Morfológica 1º Trimestre (Translucência Nucal)",
      "Obstétrica Morfológica 1º Trimestre Gemelar (Translucência Nucal) – CADA FETO",
      "Obstétrica Morfológica 1º Trimestre com Doppler (Translucência Nucal)",
      "Obstétrica Morfológica 1º Trimestre Gemelar com Doppler (Translucência Nucal) – CADA FETO",
      "Obstétrica Morfológica 2º Trimestre",
      "Obstétrica Morfológica 2º Trimestre Gemelar – CADA FETO",
      "Obstétrica Morfológica 2º Trimestre com Doppler",
      "Obstétrica Morfológica 2º Trimestre Gemelar com Doppler – CADA FETO",
      "Obstétrica Convencional com Doppler",
      "Obstétrica Convencional Gemelar com Doppler – CADA FETO",
      "Obstétrica Convencional com Doppler 4D",
      "Obstétrica Convencional Gemelar com Doppler 4D – CADA FETO",
      "Órgãos Superficiais (Tireoide, Glândulas Salivares, Escroto e Pênis)",
      "Panturrilha",
      "Parede Abdominal",
      "Partes Moles",
      "Pé",
      ...
      "Próstata Transretal",
      "Punção Aspirativa por Agulha Fina (PAAF) – Mama e Tireoide",
      ...
      "Transvaginal para Controle de Ovulação (3 ou Mais Anexos)"
    ],
  },
  {
    ...
    procedures: [
      ...
      "Angio-RM de Membros Superiores",
      "Angio-RM de Pescoço",
      "Angio-RM das Artérias Renais",
      "Antebraço",
      ...
      "Calcanhar",
      "Clavícula",
      "Colangiorressonância (MRCP)",
      "Coluna Cervical",
      "Coluna Lombar",
      "Coluna Sacrococcígea",
      "Coluna Torácica",
      "Coluna Total",
      "Corpo Inteiro (Whole-Body MRI)",
      "Cotovelo",
      "Coxa",
      "Crânio",
      "Dedo da Mão",
  ...
  },
  {
    ...
    procedures: [
      ...
      "Hemitórax",
      "Joelho",
      "Laringe ou Hipofaringe ou Pescoço (PAF)",
      "Mão",
  ...
  },
  {
    ...
    procedures: [
      "Abdome Superior e Inferior (Abdome Total)",
      "Angio-TC da Artéria Subclávia (Arterial e Venoso)",
      "Angio-TC de Abdome Inferior (Arterial e Venoso)",
      "Angio-TC de Abdome Superior (Arterial e Venoso)",
      "Angio-TC de Crânio (Arterial e Venoso)",
      "Angio-TC de Membro Inferior (Arterial e Venoso)",
      "Angio-TC de Membro Superior (Arterial e Venoso)",
      "Angio-TC de Pescoço (Arterial e Venoso)",
      "Angio-TC de Tórax (Arterial e Venoso)",
      "Antebraço",
      "Articulação Sacroilíaca",
      "Articulação Temporomandibular (ATM)",
      "Bacia",
      ...
      "Calcâneo",
      "Clavícula",
      "Coluna Cervical, Torácica, Lombar e Sacrococcígea",
      "Colonoscopia Virtual (TC 3D)",
      "Cotovelo",
      "Coxa",
      "Crânio",
      "Enterotomografia",
